    ...
    <section className="lg:px-48 px-6 pt-20">
      <div className="grid lg:grid-cols-3 grid-cols-1 gap-8">
        <div className=" flex flex-col items-center text-center lg:items-start lg:text-left justify-center space-y-6">
          ...
          <h1 className="text-3xl md:text-4xl duration-300 font-bold dark:text-white">
      ...
      <div className="py-20">
        <div className={`py-20 bg`}>
          <div className="flex items-center justify-around gap-8 flex-wrap text-center md:text-4xl sm:text-3xl text-2xl duration-300 lg:text-5xl">
            <div className="">
              <strong className="">
